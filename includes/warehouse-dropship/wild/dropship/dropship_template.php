...
<script type="text/javascript">
    ...
    function change_dropship_zip()
    {
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-cortigo-edition/includes/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-cortigo-edition/includes/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-cortigo-edition/includes/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-cortigo-edition/includes/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
            ...
            <div class="content">
                ...
                <form method="post" id="add_dropships">
                    ...
                    <?php 
                        $disabled = "";
                        $package_required = "";
                        $plugin_tab = (isset($_REQUEST['tab'])) ? $_REQUEST['tab'] : "";
                ...
                -->
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="warehouse_heading pakage_notify heading_right"><?php echo $package_required; ?></h2>
                        </a>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <div class="pickup-delivery-checkboxes">
                            <input type="checkbox" title="Enable in-store pick up" id="enable-instore-pickup" data-optional="1" name="enable-instore-pickup" value="" class="enable-instore-pickup <?php echo $disabled; ?>" />
                        </div>
                    </div>
                    <div class="en_wd_add_warehouse_input ">
                        <label>Offer if address is within (miles):</label>
                        <input type="text" title="Offer if address is within (miles):" data-optional="1" onchange="validate_delivery_fee(this);" id="instore-pickup-address" class="<?php echo $disabled; ?>" name="instore-pickup-address">
                    </div>
                    <div class="en_wd_add_warehouse_tagging">
                        <label>Offer if postal code matches:</label>
                        <div data-tags-input-name="tag" title="Offer if postal code matches:" data-optional="1" id="instore-pickup-zipmatch" value="" name="instore-pickup-zipmatch" class="tagging-js <?php echo $disabled; ?>"></div>
                    </div>

                    <div class="en_wd_add_warehouse_input">
                        <label>Checkout description:</label>
                        <input type="text" class="<?php echo $disabled; ?>" title="Checkout description:" id="instore-pickup-desc" placeholder="In-store pick up" data-optional="1" name="instore-pickup-desc">
                    </div>
                ...
                -->
                    ...
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="local-delivery-heading pakage_notify heading_right"><?php echo $package_required; ?></h2>
                        </a>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <div class="pickup-delivery-checkboxes">
                            <input type="checkbox" title="Enable local delivery" id="enable-local-delivery" data-optional="1" name="enable-local-delivery" value="" class="enable-local-delivery <?php echo $disabled; ?>" />
                        </div>
                    </div>
                    <div class="en_wd_add_warehouse_input">
                        <label>Offer if address is within (miles):</label>
                        <input type="text" title="Offer if address is within (miles):" class="<?php echo $disabled; ?>" data-optional="1" onchange="validate_delivery_fee(this);" id="local-delivery-address" name="local-delivery-address">
                    </div>
                    <div class="en_wd_add_warehouse_tagging">  
                        <label>Offer if postal code matches:</label>
                        <div data-tags-input-name="tag" title="Offer if postal code matches:" data-optional="1" id="local-delivery-zipmatch" value="" name="local-delivery-zipmatch" class="tagging-js <?php echo $disabled; ?>"></div>
                    </div>
                    <div class="en_wd_add_warehouse_input">
                        <label>Checkout description:</label>
                        <input id="local-delivery-desc" title="Checkout description:" placeholder="Local delivery" type="text" class="<?php echo $disabled; ?>" data-optional="1" name="local-delivery-desc">
                    </div>
                    <div class="en_wd_add_warehouse_input">
                        <label>Local delivery fee</label>
                        <input type="text" class="<?php echo $disabled; ?>" title="Local delivery fee" data-optional="1" onchange="validate_delivery_fee(this);" id="local-delivery-fee" name="local-delivery-fee">
                        <span class="en_wd_err"></span>
                    </div>
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <div class="pickup-delivery-checkboxes <?php echo $disabled; ?>">

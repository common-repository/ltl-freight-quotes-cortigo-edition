    ...
    class EnWooWdAddonsAjaxReqIncludes
    {
        ...
        function get_address_api_ajax()
        {
            if (isset($_POST['origin_zip'])) {
                ...
                $accessLevel = 'address';
                $Get_cortigo_freights_distance = new Get_cortigo_freights_distance();
                $resp_json = $Get_cortigo_freights_distance->cortigo_freights_get_distance($zipCode, $accessLevel);
